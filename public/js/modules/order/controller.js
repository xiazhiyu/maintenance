...
function orderDisplayController($scope,orderService,$routeParams){
    
   
  if($routeParams.id){
      orderService.getCustomerById($routeParams.id,function(data){
        $scope.order = data;
        if($scope.order.billCustomerId){
             orderService.getCustomerById($scope.order.billCustomerId,function(billCustomer){
...
function orderCreateController($scope,orderService){
